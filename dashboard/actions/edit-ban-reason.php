  ...
  if(isset($_POST['submit'])){
    ...
    $update = date("h:ia - Y.m.d");
      ...
      if(mysqli_query($conn,$sql)){
        $sql4 = "INSERT INTO staffcoreui_staff_activities(USER_ID,ACTIVITY_TEXT,PERFORMED) VALUES ('".$_SESSION['user_id']."','updated a Ban-Reason with the Name ".$_POST['oldname']."','".$update."')";
        if(mysqli_query($conn,$sql4)){
          header("Location: ../admin/manager/ban/?success=Reason%20was%20updated%21");
        } else {
          header("Location: ../admin/manager/ban/?success=Reason%20was%20updated%21");
        }
      } else {
